            ...
            <div class="admin-card">
                ...
                <div class="admin-card-body">
                    ...
                    <div class="aform-group">
                        ...
                        <textarea id="address" name="address" class="aform-control" rows="2">{{ old('address', $supplier->address ?? '') }}</textarea>
                    </div>
                    ...
                    <label class="toggle-wrap">
                        <div class="toggle">
                            ...
                            <input type="checkbox" name="is_active" value="1"
                                   {{ old('is_active', $editing ? ($supplier->is_active ? '1' : '0') : '1') == '1' ? 'checked' : '' }}>
